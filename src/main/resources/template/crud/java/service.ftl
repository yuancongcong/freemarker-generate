...
import com.lingxi.framework.domain.jpa.JpaQuery;
...
@Service
@Slf4j
public class ${service_name} extends CRUDService<${entity_name}> {

    @Autowired
    private ${dao_name} ${var_dao_name};

    @Override
    public BaseDao<${entity_name}> getBaseDao() {
        return ${var_dao_name};
    }
